...
const Lesson6_1 = () => {
    ...
    return (
        ...
        <div className="lessonHeading">
            <div>
                <h2>Dealing with Setbacks - 1</h2>
                <br></br>
                <div className="player-wrapper">
                    <ReactPlayer
                        className="react-player"
                        url="https://www.youtube.com/embed/tA7iCb9_YXc"
                        width="100%"
                        height="100%"
                        controls={true}
                    />
                        ...
                        <div className="charts__right">
                            <div>
                                <div className="lessonBody">
                                    <h3>Cognitive Behavorial Therapy is a form of psychotherapy that talk about:
        ...
        <div className="col-3">
            <p>From, &nbsp; Teten, A. and Cully, J., 2008. A Therapist’s Guide to Brief Cognitive Behavioral Therapy. 1st ed. Houston: Department of Veterans Affairs, South Central Mental Illness Research, Education, and Clinical Center (MIRECC). </p>
        </div>
