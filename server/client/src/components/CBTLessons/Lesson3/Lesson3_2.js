...
const Lesson3_2 = () => {
    ...
    return (
        ...
        <div className="lessonHeading">
            <div>
                <h2>Belief System - 2</h2>
                <br></br>
                <div className="player-wrapper">
                    <ReactPlayer
                        className="react-player"
                        url="https://www.youtube.com/embed/vu7_iFVAaJU"
                        width="100%"
                        height="100%"
                    />
                </div>
        ...
        <div className="col-3">
            <p>From, &nbsp; Mainehealth.org. 2021. [online] Available at: &lt;https://www.mainehealth.org/-/media/MaineHealth/PDFs/Clinical-Guidelines-and-Resources/SelfHelpCourse-in-CBT.docx&gt; [Accessed 22 April 2021].</p>
        </div>
